export default {
	...
	mjchat: {
		...
		imgcreate: "生成图片",
		imginfo:
			"其他参数：  <li>1 --no 忽略 --no car 图中不出现车 </li><li>2 --seed 可先获取种子 --seed 123456 </li> <li>3 --chaos 10 混合(范围：0-100)</li> <li>4 --tile 碎片化 </li> ",
		tStyle: "风格",
		tView: "视角",
		tShot: "人物镜头",
		tLight: "灯光",
		...
		tStyles: "艺术程度",
		tVersion: "模型版本",
		dalleInfo: " 说明： <li>图片有时效性，请做好备份</li> ",
		version: "版本",
		size: "尺寸",
	...
	mj: {
		...
		wsrvClose: "关闭 wsrv",
		wsrvOpen: "开启 wsrv",
		dall2Name: "ApexDraw 基础版",
		dall3Name: "ApexDraw 高级版",
	},
	login: {
		login: "登录",
	},
